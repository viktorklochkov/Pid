...
// set functions for parametrization of momentum dependance and some dummy starting values
  TF1 pion0("pion_A", "exp([0]+[1]*x)", 0.1, 10);
  pion0.SetParameters(20., -2.);
  TF1 pion1("pion_mean", "pol2", 0.1, 10);
  pion1.SetParameters(TMath::Power(PidParticles::masses[PidParticles::kPion], 2), 0, 0);
  TF1 pion2("pion_sigma", "pol2", 0.1, 10);
  pion2.SetParameters(0.01, 0.0, 0);
  ...
  pion =
      tof.GetParticleSpecie(PidParticles::kPion);   // move ParticleFit back to our object. That is done to avoid pointers usage -> move semantics
  tof.Clear();
// // // // // // // // // // // // // // // // // // 
...
// // // // // // // // // // // // // // // // //   
  ...
  TF1 kaon0("kaon0", "exp([0]+[1]*x)", 0.1, 10);
  kaon0.SetParameters(10., -1.);
  TF1 kaon1("kaon1", "pol2", 0.1, 10);
  kaon1.SetParameters(TMath::Power(PidParticles::masses[PidParticles::kKaon], 2), 0, 0);
  TF1 kaon2("kaon2", "pol2", 0.1, 10);
  kaon2.SetParameters(0.01, 0.0, 0);
...
// // // // // // // // // // // // // // // // //   
  ...
  proton1.SetParameters(TMath::Power(PidParticles::masses[PidParticles::kProton], 2), 0, 0);
...
// // // // // // // // // // // // // // // // //   
  ...
  TF1 bg0("bg0", "pol2", 0.1, 10);
  bg0.SetParameters(100, 0, 0);
  TF1 bg1("bg1", "pol2", 0.1, 10);
  bg1.SetParameters(0, 0, 0);
  TF1 bg2("bg2", "pol2", 0.1, 10);
  bg2.SetParameters(0.0, 0.0, 0);
