...
void fit_botvina14 () {
  ...
  TString inputFileName = "errMenager.root";
  TString cutsFileName = "cuts.root";
  ...
  for (int a=0;a<LoopN;a++)
  {
    ...
    tof.SetOutputFileName(FullNameOut+"pionpos.root");
    tof.Fit();
    ...
    tof.SetRangeX( xmin, xmax );
    tof.SetRangeY( ymin, ymax );
    tof.SetOutputFileName(FullNameOut+"kaonpos.root");
    tof.Fit();
    ...
    tof.SetRangeX( xmin, xmax );
    tof.SetRangeY( ymin, ymax );
    tof.SetOutputFileName(FullNameOut+"proton.root");
    tof.Fit();
    ...
    cout << "\n\nhe3\n";
    std::unique_ptr <TH2D> hhe3 {(TH2D*) fIn->Get(FullName+"hHe3")};
    ...
    tof.SetRangeX( xmin, xmax );
    tof.SetRangeY( ymin, ymax );
    tof.SetOutputFileName(FullNameOut+"he3.root");
    tof.Fit();
    ...
    tof.SetRangeX( xmin, xmax );
    tof.SetRangeY( ymin, ymax );
    tof.SetOutputFileName(FullNameOut+"deutron.root");
    tof.Fit();
    ...
    */
    ...
    //forced truefit
    /*
    pionpos.SetIsFixed( {true, true, true} );
    kaonpos.SetIsFixed( {true, true, true} );
    proton.SetIsFixed ( {true, true, true} );
    deutron.SetIsFixed( {true, true, true} );
    he3.SetIsFixed( {true, true, true} );
    */
    //end of force
    ...
    tof.SetRangeX( xmin, xmax );
    tof.SetRangeY( ymin, ymax );
    tof.SetOutputFileName(FullNameOut+"allpos.root");
    tof.Fit();
    ...
    tof.SetRangeX( xmin, xmax );
    tof.SetRangeY( ymin, ymax );
    tof.SetOutputFileName(FullNameOut+"pionneg.root");
    tof.Fit();
    ...
    tof.SetRangeX( xmin, xmax );
    tof.SetRangeY( ymin, ymax );
    tof.SetOutputFileName(FullNameOut+"kaonneg.root");
    tof.Fit();
    ...
    std::unique_ptr <TH2D> hneg {(TH2D*) fIn->Get(FullName+"hAll")};
    hneg->Rebin2D(1,1);
    tof.SetChi2Max(1e6);
    ...
    tof.SetRangeX( xmin, xmax );
    tof.SetRangeY( ymin, ymax );
    tof.SetOutputFileName(FullNameOut+"allneg.root");
    tof.Fit();
    ...
    getter.Write(FullName+"pid_getter");
  }
  outfile->Close();
}
